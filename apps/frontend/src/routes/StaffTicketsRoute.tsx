...
import { Trophy, Clock, Search, CheckCircle2, XCircle, Loader2 } from "lucide-react";
import {
  useTickets,
  useLeaderboard,
  useClaimTicket,
...
/**
 * The report queue — one section of the staff suite (see routes/staff/StaffLayout.tsx).
 *
 * Until the suite existed this route was linked from nowhere in the entire app: the ticket
 * workflow was built, deployed and unreachable. The suite owns the header, the role gate and the
 * scroll container now, so this renders only its own status tabs.
 */
